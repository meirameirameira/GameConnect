    ...
    [819], {
        ...
        6866: (e, t) => {
            ...
            const n = elementorFrontendConfig.urls.assets,
                ...
                i = elementorFrontendConfig.experimentalFeatures.e_swiper_latest ? `${n}lib/swiper/v8/swiper${o}.js?ver=8.4.5` : `${n}lib/swiper/swiper${o}.js?ver=5.3.6`,
                r = elementorFrontendConfig.experimentalFeatures.e_swiper_latest ? `${n}lib/swiper/v8/css/swiper${o}.css?ver=8.4.5` : `${n}lib/swiper/css/swiper${o}.css?ver=5.3.6`;
            AssetsLoader.assets = {
                script: {
                    dialog: {
                ...
                style: {
                    ...
                    "e-lightbox": {
                        src: `${n}css/conditionals/lightbox${o}.css?ver=${s}`
                    },
                    dialog: {
        ...
        5719: (e, t, n) => {
            ...
            var C = i(f),
                A = C.prototype;
            if (A.constructor !== C)
                for (var $ in p || a(A, "constructor", r(1, C)), h)
                    if (l(h, $)) {
                        var D = h[$],
                            L = D.s;
                        l(C, L) || a(C, L, r(6, D.c))
