...
! function($, obj) {
    ...
    obj.init = function(detailsElems) {
        obj.event_listeners()
    }, obj.selectors = [".tribe-tickets__item__details__summary--more", ".tribe-tickets__item__details__summary--less"], obj.event_listeners = function() {
        ...
        if (trigger) {
            var $trigger = $(trigger);
            if ($trigger.hasClass("tribe-tickets__item__details__summary--more") || $trigger.hasClass("tribe-tickets__item__details__summary--less")) {
                ...
                if ($target && $parent) {
                    ...
                    $parent.toggleClass("tribe__details--open", onOff), $target.toggleClass("tribe__details--open", onOff)
                }
            }
        }
    }, $((function() {
